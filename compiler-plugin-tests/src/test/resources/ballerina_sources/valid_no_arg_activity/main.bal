...
// Workflow function that calls activities - both with and without args
@workflow:Workflow
function noArgActivityWorkflow(workflow:Context ctx, ProcessInput input) returns ProcessResult|error {
